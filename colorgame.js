var numSquares = 6;
var colors = [];
var pickedColor; // This picks the goal color (the color that is to be guessed).
...
// Inside of the init() function, we'll put everything that needs to run when the page loads.
init();
...
function setUpModeButtons(){
	for(var i = 0; i < modeButtons.length; i++){
		modeButtons[i].addEventListener("click", function(){
			...
			this.textContent === "Easy" ? numSquares = 3: numSquares = 6; // This line does the same thing as lines 46-50.
